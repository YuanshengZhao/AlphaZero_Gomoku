...
a0eng=RN_Gomoku.A0_ENG(64,"./RNG64.tf",1e-1/(2.0**1))
...
# else:
hist=a0eng.a0_eng.fit(np.concatenate((x_tr,x_vl)),np.concatenate((y_tr,y_vl)),epochs=1,shuffle=True,batch_size=btze,validation_data=(x_vl,y_vl))
