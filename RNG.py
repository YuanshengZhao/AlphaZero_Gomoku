...
class RN_GM(tf.keras.Model):
    def __init__(self,nflter):
        ...
        #seRN tower
        self.conv11 = tf.keras.layers.Conv2D(nflter,3,padding='same',use_bias=False,kernel_regularizer=l2(2e-4))
        self.conv12 = tf.keras.layers.Conv2D(nflter,3,padding='same',use_bias=False,kernel_regularizer=l2(2e-4))
        self.conv21 = tf.keras.layers.Conv2D(nflter,3,padding='same',use_bias=False,kernel_regularizer=l2(2e-4))
        self.conv22 = tf.keras.layers.Conv2D(nflter,3,padding='same',use_bias=False,kernel_regularizer=l2(2e-4))
        self.conv31 = tf.keras.layers.Conv2D(nflter,3,padding='same',use_bias=False,kernel_regularizer=l2(2e-4))
        self.conv32 = tf.keras.layers.Conv2D(nflter,3,padding='same',use_bias=False,kernel_regularizer=l2(2e-4))
        self.conv41 = tf.keras.layers.Conv2D(nflter,3,padding='same',use_bias=False,kernel_regularizer=l2(2e-4))
        self.conv42 = tf.keras.layers.Conv2D(nflter,3,padding='same',use_bias=False,kernel_regularizer=l2(2e-4))
        self.conv51 = tf.keras.layers.Conv2D(nflter,3,padding='same',use_bias=False,kernel_regularizer=l2(2e-4))
        self.conv52 = tf.keras.layers.Conv2D(nflter,3,padding='same',use_bias=False,kernel_regularizer=l2(2e-4))
        self.conv61 = tf.keras.layers.Conv2D(nflter,3,padding='same',use_bias=False,kernel_regularizer=l2(2e-4))
        self.conv62 = tf.keras.layers.Conv2D(nflter,3,padding='same',use_bias=False,kernel_regularizer=l2(2e-4))
        self.conv71 = tf.keras.layers.Conv2D(nflter,3,padding='same',use_bias=False,kernel_regularizer=l2(2e-4))
        self.conv72 = tf.keras.layers.Conv2D(nflter,3,padding='same',use_bias=False,kernel_regularizer=l2(2e-4))
        self.conv81 = tf.keras.layers.Conv2D(nflter,3,padding='same',use_bias=False,kernel_regularizer=l2(2e-4))
        self.conv82 = tf.keras.layers.Conv2D(nflter,3,padding='same',use_bias=False,kernel_regularizer=l2(2e-4))
        self.conv91 = tf.keras.layers.Conv2D(nflter,3,padding='same',use_bias=False,kernel_regularizer=l2(2e-4))
        self.conv92 = tf.keras.layers.Conv2D(nflter,3,padding='same',use_bias=False,kernel_regularizer=l2(2e-4))
        self.conva1 = tf.keras.layers.Conv2D(nflter,3,padding='same',use_bias=False,kernel_regularizer=l2(2e-4))
        self.conva2 = tf.keras.layers.Conv2D(nflter,3,padding='same',use_bias=False,kernel_regularizer=l2(2e-4))
        self.gap11 = tf.keras.layers.AveragePooling2D(15)
        self.fct11 = tf.keras.layers.Dense(se_chnl,activation='relu',kernel_regularizer=l2(2e-4),bias_regularizer=l2(2e-5))
        self.fct12 = tf.keras.layers.Dense(nflter,activation='sigmoid',kernel_regularizer=l2(2e-4),bias_regularizer=l2(2e-5))
        self.gap21 = tf.keras.layers.AveragePooling2D(15)
        self.fct21 = tf.keras.layers.Dense(se_chnl,activation='relu',kernel_regularizer=l2(2e-4),bias_regularizer=l2(2e-5))
        self.fct22 = tf.keras.layers.Dense(nflter,activation='sigmoid',kernel_regularizer=l2(2e-4),bias_regularizer=l2(2e-5))
        self.gap31 = tf.keras.layers.AveragePooling2D(15)
        self.fct31 = tf.keras.layers.Dense(se_chnl,activation='relu',kernel_regularizer=l2(2e-4),bias_regularizer=l2(2e-5))
        self.fct32 = tf.keras.layers.Dense(nflter,activation='sigmoid',kernel_regularizer=l2(2e-4),bias_regularizer=l2(2e-5))
        self.gap41 = tf.keras.layers.AveragePooling2D(15)
        self.fct41 = tf.keras.layers.Dense(se_chnl,activation='relu',kernel_regularizer=l2(2e-4),bias_regularizer=l2(2e-5))
        self.fct42 = tf.keras.layers.Dense(nflter,activation='sigmoid',kernel_regularizer=l2(2e-4),bias_regularizer=l2(2e-5))
        self.gap51 = tf.keras.layers.AveragePooling2D(15)
        self.fct51 = tf.keras.layers.Dense(se_chnl,activation='relu',kernel_regularizer=l2(2e-4),bias_regularizer=l2(2e-5))
        self.fct52 = tf.keras.layers.Dense(nflter,activation='sigmoid',kernel_regularizer=l2(2e-4),bias_regularizer=l2(2e-5))
        self.gap61 = tf.keras.layers.AveragePooling2D(15)
        self.fct61 = tf.keras.layers.Dense(se_chnl,activation='relu',kernel_regularizer=l2(2e-4),bias_regularizer=l2(2e-5))
        self.fct62 = tf.keras.layers.Dense(nflter,activation='sigmoid',kernel_regularizer=l2(2e-4),bias_regularizer=l2(2e-5))
        self.gap71 = tf.keras.layers.AveragePooling2D(15)
        self.fct71 = tf.keras.layers.Dense(se_chnl,activation='relu',kernel_regularizer=l2(2e-4),bias_regularizer=l2(2e-5))
        self.fct72 = tf.keras.layers.Dense(nflter,activation='sigmoid',kernel_regularizer=l2(2e-4),bias_regularizer=l2(2e-5))
        self.gap81 = tf.keras.layers.AveragePooling2D(15)
        self.fct81 = tf.keras.layers.Dense(se_chnl,activation='relu',kernel_regularizer=l2(2e-4),bias_regularizer=l2(2e-5))
        self.fct82 = tf.keras.layers.Dense(nflter,activation='sigmoid',kernel_regularizer=l2(2e-4),bias_regularizer=l2(2e-5))
        self.gap91 = tf.keras.layers.AveragePooling2D(15)
        self.fct91 = tf.keras.layers.Dense(se_chnl,activation='relu',kernel_regularizer=l2(2e-4),bias_regularizer=l2(2e-5))
        self.fct92 = tf.keras.layers.Dense(nflter,activation='sigmoid',kernel_regularizer=l2(2e-4),bias_regularizer=l2(2e-5))
        self.gapa1 = tf.keras.layers.AveragePooling2D(15)
        self.fcta1 = tf.keras.layers.Dense(se_chnl,activation='relu',kernel_regularizer=l2(2e-4),bias_regularizer=l2(2e-5))
        self.fcta2 = tf.keras.layers.Dense(nflter,activation='sigmoid',kernel_regularizer=l2(2e-4),bias_regularizer=l2(2e-5))
        #pv head
...
class MixedLoss(tf.keras.losses.Loss):
    ...
    def call(self, y_true, y_pred):
        return self.cce(y_true[:,:-1],y_pred[:,:-1])+self.bce(y_true[:,-1],y_pred[:,-1])
